# 1. 欢迎访问中山学院计算机新生群 Q&A

这个页面是由 2017 计机新生群管理组创建的，现在由 2019 计机新生群管理组维护，目的是让新生们快速解决自己的疑惑，避免在群内一次又一次地问重复 & 没有意义的问题。
...
**最新文档**：[2019新生入学须知](https://docs.qq.com/doc/DR0FHV0h4cW9KYUtY)

A: 报到手续资料【请仔细阅读学校下发的资料】

1. 录取通知书原件【及其复印件x1】

2. 身份证原件及【复印件两份，A4纸正反面】

3. 纸质学生档案【政府统一寄出的除外】

4. 党/团员资料【若有】

5. 户口是否需要随迁自愿选择，需要的话办好 户口迁移证
...
Q: 学校微信公众号？  
A: 微信搜索电子科技大学中山学院，可以搜到「电子科技大学中山学院」：官方公众号，服务号，图书馆公众号，财务处公众号等。请认准公众号名字后边的「认证」小勾勾。
...
Q: 中山北站与中山站是同一个站吗？   
A: **不是**，中山北站只停城轨列车（C 开头），中山站可停高铁及城轨。请购票时注意区分。
...
A: 绝大部分情况是不可能的, 但的确有特殊情况, 但请不要有歪心思.
...
Q: 电费怎么算，怎么交电费？   
A: 会送一点电费, 超出的(一般来讲)宿舍所有人平摊，0.677 元一度电，预付费模式，余额不足立即停电。(你应该及时缴费, 骤时断电会对电器产生一定影响)

可以关注「莲峰后勤」公众号（微信号：**dzkjdxzsxyhqbzb**），绑定你的宿舍号，电费过低会提醒（有时候会抽风不提醒），可以也仅可以在上面直接充电费.
...
Q: 宿舍有电梯吗？   
A: 除了香晖苑 / 朝晖苑有电梯，其他均没有，不过楼层一般在 8 楼以下。

Q: 宿舍有网络吗？   
A: 每个床位均有网络接口。也配备了无线网络。其中 1 - 6 栋及朝晖苑可选电信、移动线路，香晖苑可选移动、联通及电信线路。其他宿舍区只有电信线路。周日到周四晚 11 点半准时断网，周五周六晚 12 点断网，节假日不断网。

Q: 我想跟同班的 XXX 住在一起，可能吗？   
A: 同时网上选同一间宿舍，安排在一起可能性比较大。
...
A: [校历 | 2019-2020 学年校历表](https://mp.weixin.qq.com/s/i-4Fngg2OElztUr7q-1R_A) 官方推文，以下图片来自该推文。

![image-20190730225642452](assets/image-20190730225642452.png)



![image-20190730225656464](assets/image-20190730225656464.png)
...
Q: 为什么我的录取情况显示计算机类？   
A: 计算机学院按照 “计算机类” 大类招生，各个专业基础课程完全打通，学生入校一年后再根据专业学习情况，结合自己兴趣和特长选择专业（计算机科学与技术、软件工程、网络工程、数字媒体技术），再进入专业培养。

Q: 我都有些什么课？这些专业是学什么的？   
A: 请参阅 [计算机学院专业介绍](http://zsb.zsc.edu.cn/zsxx/yxsz/sjs/) <sup>2</sup>，开学后班导 / 辅导员会提供专业人才培养方案给你们。

Q: 我想先预习一下大一的课程，应该学些什么？   
A: 大一 一般是学习 "C 语言程序设计"(c++在19级被取消)，具体以当年教学内容为准.  
...
Q: 能作弊吗？   
A: **作弊一次将做结业处理, 作弊两次直接退学, 没有酌情处理**, 所以你说呢？
...
Q: 什么时候才可以考四级？   
A: 四六级考试一般在 6 月 / 12 月各有一场，2019 年入学的同学在第一学期就可以参加四级考试，要根据学校安排。
...
- **借书相关**
   ...
   在图书馆的官网描述中 [这里](http://lib.zsc.edu.cn/)，一般学生最多可以借阅中文图书 15 本，借期 60 天，可续借一次（ 30 天）。有个小特殊情况是，如果你的还书日期在寒暑假放假中的话，还书日期会自动延期到返校后，使用得当的话可以“延长” 你的借阅时间。

- **关于计算机书籍**

   学校的计算机类书籍已经非常丰富了，有些实体书较贵的经典书也会有，个人还是挺推荐大家在大学有空的时候找找自己需要的书看。并且可以通过购书推荐来让学校购买较新出版的书籍 [这里](http://210.38.230.180:8080/asord/asord_redr.php) (需要先登录, 最好直接从首页进)
...
- **论文查询**
   ...
   这个很重要，很重要，很重要。在以前可以通过学校的 ip 在中国知网、万方 等重要的平台去有限量地 **免费** 下载论文。刚开始对论文需求不大一般没什么感觉。当需要这种服务的时候，就会觉得这是个非常好的资源了。
...
- 第一志愿报考我校被录取，高考总分（不含政策性加分）达到以下条件
  ...
  - 2019 年本科为一个批次的省：**文科** 在本科线上前 20%，**理科** 在本科线上前 30% 的考生，奖励 5 万元 / 生；  
  
  - 2019 年本科分为重点、非重点批次的省：高考总分达到重点本科批次线及以上，奖励 5 万元 / 生。  
    参阅[电子科技大学中山学院 2019 级新生奖学金方案](电子科技大学中山学院 2019 级新生奖学金方案)
...
Q: 是否需要考计算机语言等级考试？  
A: 可以 没必要，但是可以顺手考一下，对于从事 IT 行业的人来说计算机语言等级证书看起来不会给你带来任何优势。(这就和外国语专业的跑去考大学英语四级考试性质差不多)  
...
### 1.2.8. 军训
Q: 军训多久？   
A: 2019 级入学教育、开学典礼及军训时间推迟为 10 月 14 日至 10 月 27 日。
...
A: 学校校园网络支持有线和无线连接，不过有的宿舍区无线网络不稳定，建议有线连接，电脑没有有线接口的可以买一个 USB 转换器；如果选择使用电信宽带网络，电脑端需要下载安装认证软件，认证成功才可以上网，学校大多数地方覆盖了 F-young 无线网络。在少人抢和信号强的地方网速还是挺快的，手机端也需要下载一个 app 认证，可以同时一台电脑一台手机在线。这个电信的电脑认证软件暂时只有 windows 平台和 ios 平台的，并没有 linux 等平台的～(其实有，不过较为不稳定，所以不推广).

至于联通移动宽带是通过电脑自带的 PPPoE 拨号上网，但是他们目前并没有免费 wifi 使用，只能同时一台电脑在线。鉴于学校的网络架构，个人建议追求稳定性高的选电信，追求方便的选移动联通(前提是你能选[滑稽]）.

Q: 上网费用？

A: 男生 (本科生) 暂时只可以使用电信宽带，住在香晖苑的可以使用电信联通移动网络。住在凤翔或朝晖苑的可以使用电信移动网络。不同运营商资费不同，具体开学的时候会有运营商设点在你们楼下宣 (xi) 传(nao).

Q: 网速怎么样？

A: 不同运营商资费，服务不同，有的 20M 有的 50M 有的 100M……
...
A: 通过「网络维护科」公众号（微信号：zsxyww）报修，会有小哥哥小姐姐上门处理哦，不过网络维护科并不属于运营商的，也不是个盈利性组织，所以麻烦各位不要无理由性凶他们呢~

Q: 要带网线吗？

A: 你喜欢，学校信息中心也有网线出售，信息中心在实验楼 B207，北门外面的小商店也有网线出售。不过个人建议，在北门外面的商店买网线的话，蓝色的那种，摸起来有空心的不要买，质量有点差.
